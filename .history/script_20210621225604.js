...
function create() {
   ...
   //total = 2;
    for(var i = 0; i < total; i++){
        ...
        console.log(final_arr[i].substring(9))
        console.log(cal_day(parseInt(final_arr[i].substring(0, 4)),parseInt(final_arr[i].substring(5, 7)), parseInt(String(final_arr[i].substring(9)))))
    }
    //total /= 2
    console.log(final_arr.join())
